 ...
 * BASIC
 */
$config['site_title'] = 'Le guide du brasseur';              // Site title
$config['base_url'] = 'http://sibert.cluster003.ovh.net/le-guide-du-brasseur';                    // Override base URL (e.g. http://example.com)
